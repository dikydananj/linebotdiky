...
DpkBot=[SELFBOT]
Owner=["u12e9adb8790c9fd8955bf2f11a2f2ccd"]
...
Wait = {
    ...
    "Unban":False,
    "Admin": {
        "u12e9adb8790c9fd8955bf2f11a2f2ccd":True #MID ADMIN TARO DISINI
    },
}
                    ...
                    if arif.param1 in DpkCctv['Point2']:  
                        ...
                        if Name in DpkCctv['Point3'][arif.param1]:
                            ...
                            if " " in Name:
                                nick = Name.split(' ')
                                if len(nick) == 2:
                                    cl.mentionWithDPK(arif.param1,arif.param2," Woy\n","" + "\n Nyimak doang ga hargain ?" )
                                else:
                                    cl.mentionWithDPK(arif.param1,arif.param2," Nah\n","" + "\n Respon masa cuma liat doang ??" )
                            else:
                                cl.mentionWithDPK(arif.param1,arif.param2," Heh\n","" + "\n Baca aja terus?" )
                    else:
                        pass
                else:
                    pass
              ...
              try:
                  ...
                  if msg.id in msg_dict:
                    if msg_dict[msg.id]["pelaku"]:
                        ...
                        cl.mentionWithDPK(you,user," Hayoloh ","\n\n" +str(dia))
              except:
